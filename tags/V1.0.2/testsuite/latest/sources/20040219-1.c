/* FIXME: install\lib\gcc\xpic-hilscher-elf\0.1.1\libgcc.a(muldf3.o): In function `BB1_72':
C:/DOKUME~1/ALEXAN~1/LOKALE~1/Temp/LLVM_2604/muldf3.bc:(.text+0x5cc): warning: internal error: out of range error
*/
...
main ()
{
	...
	x = (f1+f2+f3+f4+f5+f6+f7+f8+f9+f10) *
        ...
        if (x < 19503.0 || x > 19504.0) return -1;
	return 0;
}
