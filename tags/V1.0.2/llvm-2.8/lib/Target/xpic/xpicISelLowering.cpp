...
///   R E T U R N
SDValue xpicTargetLowering::LowerReturn(SDValue Chain,CallingConv::ID CallConv, bool isVarArg,const SmallVectorImpl<ISD::OutputArg> &Outs, const SmallVectorImpl<SDValue> &OutVals, DebugLoc dl, SelectionDAG &DAG) const
{
      ...
      case MVT::i32:
        ...
        {// arguments lives in stack
          ...
          {// I am not sure that programm will comes here
            ...
            Load = DAG.getExtLoad(LoadOp,MVT::i32, dl, Chain, FIPtr,NULL, 0, ObjectVT,false, false, 0);
