/* BFD library support routines for the XPIC architecture.
...
static const bfd_arch_info_type arch_info_struct[] =
{
  ...
  N (32, bfd_mach_avr3, "avr:3", FALSE, & arch_info_struct[4]),
  ...
  /* 32-Byte PC.  */
  N (32, bfd_mach_xpic, "xpic", FALSE, NULL)

};
/*bfd_elf32_avr_vec
const bfd_arch_info_type bfd_xpic_arch =
  N (32, bfd_mach_xpic, "xpic", TRUE, & arch_info_struct[0]);
*/
const bfd_arch_info_type bfd_xpic_arch =
  N (32, bfd_mach_xpic, "xpic", TRUE, & arch_info_struct[0]);
