///TODO:
/* Opcode table for the Hilscher XPIC micro controllers.
...
/** constraint letters
registers:
   d - destination reg, (trg) r0…r7,usr0…usr4,pc,stat,zero (bypassed, i.e. from last command)
   D - destination reg, for 32- bit multiplication : r0..r7,usr0…usr4,stat
                        for 64-bit mutltiplication: usr10 (code: zero); usr32 (code: pc)
   r - source 1,        (base_reg) r0…r7,usr0…usr4,pc,stat,zero (bypassed, i.e. from last command)
   w - source 2,        (wreg) r0…r7 (not bypassed, i.e. from the last but one command)
   q - source 2,        (base_reg) r0…r7,usr0…usr4,pc,stat,zero 
