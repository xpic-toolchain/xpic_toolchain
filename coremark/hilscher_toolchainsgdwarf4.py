...
def configure_toolchain_xpic(conf):
    ...
    for x in 'CFLAGS CXXFLAGS'.split():
        f(x + '_compile_debug',    ['-O0', '-g', '-gdwarf-4'])     # change debug option to NEW format gdwarf-4; just for this test!
        f(x + '_compile_debugrel', ['-Os', '-g', '-gdwarf-4'])     # change debug option to NEW format gdwarf-4; just for this test!
