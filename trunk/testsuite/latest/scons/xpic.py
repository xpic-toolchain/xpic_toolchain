...
xpic_env['CC']         = '"' + 'clang' + '"'
xpic_env['CXX']        = 'g++'
# xpic_env['CCFLAGS']    = '-v -Wimplicit -I"'+_xpicpath+'/include" -I"'+_xpicpath+'/lib/gcc/xpic-hilscher-elf/0.1.1/include"'
xpic_env['CCFLAGS']    = '--target=xpic -Os -Wimplicit -I"'+_xpicpath+'/include" -I"'+_xpicpath+'/lib/gcc/xpic-hilscher-elf/0.1.1/include"'
