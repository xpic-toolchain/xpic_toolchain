...
#define XpicVic_SetVectorIsr     NX51_XpicVic_SetVectorIsr
#define XpicVic_SetVectorSrc     NX51_XpicVic_SetVectorSrc
...
#define XpicVic_SetVectorIsr     NX10_XpicVic_SetVectorIsr
#define XpicVic_SetVectorSrc     NX10_XpicVic_SetVectorSrc
...
int main(void)
{
  ...
  XpicVic_SetVectorIsr(0, isr_count);
  XpicVic_SetVectorSrc(0, XPICVIC_INTSRC_SOFTWARE, 1);
