...
//AR:    AddPath("c:/mingw/include", System, true, false, false);
    break;
  default:
    break;
  }
...
#if 0
    // it was problems with "-I" flag, especially at compilation of libraries
// AR: add xpic special include path ("./lib/gcc/xpic-hilscher-elf/0.1.1/include")
    llvm::sys::Path xpiclibP(HSOpts.ResourceDir);
    /*  ./lib/clang/1.1/                                */
    xpiclibP.eraseComponent();//
    /*  ./lib/clang/                                    */
    xpiclibP.eraseComponent();
    /*  ./lib/                                          */
    xpiclibP.appendComponent("gcc");
    /*  ./lib/gcc/                                      */
    xpiclibP.appendComponent("xpic-hilscher-elf");
    /*  ./lib/gcc/xpic-hilscher-elf/                    */
    xpiclibP.appendComponent("0.1.1");
    /*  ./lib/gcc/xpic-hilscher-elf/0.1.1/              */
    xpiclibP.appendComponent("include");
    /*  ./lib/gcc/xpic-hilscher-elf/0.1.1/include       */
    Init.AddPath(xpiclibP.str(), System, false, false, false, /*IgnoreSysRoot=*/ true);
#endif
  }
