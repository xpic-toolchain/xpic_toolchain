...
long log1pf_vec[][8] = {
    ...
    {64,13,123,__LINE__, 0xbfefae14, 0x80000000, 0xbfefae14, 0x7ae147ac},     /* -0.99000=f(-0.99000)*/
    {64,13,123,__LINE__, 0xbfef5c29, 0x00000000, 0xbfef5c28, 0xf5c28f5a},     /* -0.98000=f(-0.98000)*/
    {64,13,123,__LINE__, 0xbfef0a3d, 0x80000000, 0xbfef0a3d, 0x70a3d708},     /* -0.97000=f(-0.97000)*/
    {64,13,123,__LINE__, 0xbfeeb851, 0xe0000000, 0xbfeeb851, 0xeb851eb6},     /* -0.95999=f(-0.96000)*/
    {64,13,123,__LINE__, 0xbfee6666, 0x60000000, 0xbfee6666, 0x66666664},     /* -0.94999=f(-0.95000)*/
    {64,13,123,__LINE__, 0xbfee147a, 0xe0000000, 0xbfee147a, 0xe147ae12},     /* -0.94000=f(-0.94000)*/
    {64,13,123,__LINE__, 0xbfedc28f, 0x60000000, 0xbfedc28f, 0x5c28f5c0},     /* -0.93000=f(-0.93000)*/
    {64,13,123,__LINE__, 0xbfed70a3, 0xe0000000, 0xbfed70a3, 0xd70a3d6e},     /* -0.92000=f(-0.92000)*/
    {64,13,123,__LINE__, 0xbfed1eb8, 0x60000000, 0xbfed1eb8, 0x51eb851c},     /* -0.91000=f(-0.91000)*/
    {64,13,123,__LINE__, 0xbfeccccc, 0xc0000000, 0xbfeccccc, 0xccccccca},     /* -0.89999=f(-0.90000)*/
    {64,13,123,__LINE__, 0xbfec7ae1, 0x40000000, 0xbfec7ae1, 0x47ae1478},     /* -0.88999=f(-0.89000)*/
    {64,13,123,__LINE__, 0xbfec28f5, 0xc0000000, 0xbfec28f5, 0xc28f5c26},     /* -0.88000=f(-0.88000)*/
    {64,13,123,__LINE__, 0xbfebd70a, 0x40000000, 0xbfebd70a, 0x3d70a3d4},     /* -0.87000=f(-0.87000)*/
    {64,13,123,__LINE__, 0xbfeb851e, 0xc0000000, 0xbfeb851e, 0xb851eb82},     /* -0.86000=f(-0.86000)*/
    {64,13,123,__LINE__, 0xbfeb3333, 0x40000000, 0xbfeb3333, 0x33333330},     /* -0.85000=f(-0.85000)*/
    {64,13,123,__LINE__, 0xbfeae147, 0xa0000000, 0xbfeae147, 0xae147ade},     /* -0.83999=f(-0.84000)*/
    {64,13,123,__LINE__, 0xbfea8f5c, 0x20000000, 0xbfea8f5c, 0x28f5c28c},     /* -0.82999=f(-0.83000)*/
    {64,13,123,__LINE__, 0xbfea3d70, 0xa0000000, 0xbfea3d70, 0xa3d70a3a},     /* -0.81999=f(-0.82000)*/
    {64,13,123,__LINE__, 0xbfe9eb85, 0x20000000, 0xbfe9eb85, 0x1eb851e8},     /* -0.81000=f(-0.81000)*/
    {64,13,123,__LINE__, 0xbfe99999, 0xa0000000, 0xbfe99999, 0x99999996},     /* -0.80000=f(-0.80000)*/
    {64,13,123,__LINE__, 0xbfe947ae, 0x20000000, 0xbfe947ae, 0x147ae144},     /* -0.79000=f(-0.79000)*/
    {64,13,123,__LINE__, 0xbfe8f5c2, 0x80000000, 0xbfe8f5c2, 0x8f5c28f2},     /* -0.77999=f(-0.78000)*/
    {64,13,123,__LINE__, 0xbfe8a3d7, 0x00000000, 0xbfe8a3d7, 0x0a3d70a0},     /* -0.76999=f(-0.77000)*/
    {64,13,123,__LINE__, 0xbfe851eb, 0x80000000, 0xbfe851eb, 0x851eb84e},     /* -0.75999=f(-0.76000)*/
    {64,13,123,__LINE__, 0xbfe80000, 0x00000000, 0xbfe7ffff, 0xfffffffc},     /* -0.75000=f(-0.75000)*/
    {64,13,123,__LINE__, 0xbfe7ae14, 0x80000000, 0xbfe7ae14, 0x7ae147aa},     /* -0.74000=f(-0.74000)*/
    {64,13,123,__LINE__, 0xbfe75c29, 0x00000000, 0xbfe75c28, 0xf5c28f58},     /* -0.73000=f(-0.73000)*/
    {64,13,123,__LINE__, 0xbfe70a3d, 0x80000000, 0xbfe70a3d, 0x70a3d706},     /* -0.72000=f(-0.72000)*/
    {64,13,123,__LINE__, 0xbfe6b851, 0xe0000000, 0xbfe6b851, 0xeb851eb4},     /* -0.70999=f(-0.71000)*/
    {64,13,123,__LINE__, 0xbfe66666, 0x60000000, 0xbfe66666, 0x66666662},     /* -0.69999=f(-0.70000)*/
    {64,13,123,__LINE__, 0xbfe6147a, 0xe0000000, 0xbfe6147a, 0xe147ae10},     /* -0.69000=f(-0.69000)*/
    {64,13,123,__LINE__, 0xbfe5c28f, 0x60000000, 0xbfe5c28f, 0x5c28f5be},     /* -0.68000=f(-0.68000)*/
    {64,13,123,__LINE__, 0xbfe570a3, 0xe0000000, 0xbfe570a3, 0xd70a3d6c},     /* -0.67000=f(-0.67000)*/
    {64,13,123,__LINE__, 0xbfe51eb8, 0x60000000, 0xbfe51eb8, 0x51eb851a},     /* -0.66000=f(-0.66000)*/
    {64,13,123,__LINE__, 0xbfe4cccc, 0xc0000000, 0xbfe4cccc, 0xccccccc8},     /* -0.64999=f(-0.65000)*/
    {64,13,123,__LINE__, 0xbfe47ae1, 0x40000000, 0xbfe47ae1, 0x47ae1476},     /* -0.63999=f(-0.64000)*/
    {64,13,123,__LINE__, 0xbfe428f5, 0xc0000000, 0xbfe428f5, 0xc28f5c24},     /* -0.63000=f(-0.63000)*/
    {64,13,123,__LINE__, 0xbfe3d70a, 0x40000000, 0xbfe3d70a, 0x3d70a3d2},     /* -0.62000=f(-0.62000)*/
    {64,13,123,__LINE__, 0xbfe3851e, 0xc0000000, 0xbfe3851e, 0xb851eb80},     /* -0.61000=f(-0.61000)*/
    {64,13,123,__LINE__, 0xbfe33333, 0x40000000, 0xbfe33333, 0x3333332e},     /* -0.60000=f(-0.60000)*/
    {64,13,123,__LINE__, 0xbfe2e147, 0xa0000000, 0xbfe2e147, 0xae147adc},     /* -0.58999=f(-0.59000)*/
    {64,13,123,__LINE__, 0xbfe28f5c, 0x20000000, 0xbfe28f5c, 0x28f5c28a},     /* -0.57999=f(-0.58000)*/
    {64,13,123,__LINE__, 0xbfe23d70, 0xa0000000, 0xbfe23d70, 0xa3d70a38},     /* -0.56999=f(-0.57000)*/
    {64,13,123,__LINE__, 0xbfe1eb85, 0x20000000, 0xbfe1eb85, 0x1eb851e6},     /* -0.56000=f(-0.56000)*/
    {64,13,123,__LINE__, 0xbfe19999, 0xa0000000, 0xbfe19999, 0x99999994},     /* -0.55000=f(-0.55000)*/
    {64,13,123,__LINE__, 0xbfe147ae, 0x20000000, 0xbfe147ae, 0x147ae142},     /* -0.54000=f(-0.54000)*/
    {64,13,123,__LINE__, 0xbfe0f5c2, 0x80000000, 0xbfe0f5c2, 0x8f5c28f0},     /* -0.52999=f(-0.53000)*/
    {64,13,123,__LINE__, 0xbfe0a3d7, 0x00000000, 0xbfe0a3d7, 0x0a3d709e},     /* -0.51999=f(-0.52000)*/
    {64,13,123,__LINE__, 0xbfe051eb, 0x80000000, 0xbfe051eb, 0x851eb84c},     /* -0.50999=f(-0.51000)*/
    {64,13,123,__LINE__, 0xbfe00000, 0x00000000, 0xbfdfffff, 0xfffffff4},     /* -0.50000=f(-0.50000)*/
    {64,13,123,__LINE__, 0xbfdf5c29, 0x00000000, 0xbfdf5c28, 0xf5c28f50},     /* -0.49000=f(-0.49000)*/
    {64,13,123,__LINE__, 0xbfdeb851, 0xe0000000, 0xbfdeb851, 0xeb851eac},     /* -0.47999=f(-0.48000)*/
    {64,13,123,__LINE__, 0xbfde147a, 0xe0000000, 0xbfde147a, 0xe147ae08},     /* -0.47000=f(-0.47000)*/
    {64,13,123,__LINE__, 0xbfdd70a3, 0xe0000000, 0xbfdd70a3, 0xd70a3d64},     /* -0.46000=f(-0.46000)*/
    {64,13,123,__LINE__, 0xbfdccccc, 0xc0000000, 0xbfdccccc, 0xccccccc0},     /* -0.44999=f(-0.45000)*/
    {64,13,123,__LINE__, 0xbfdc28f5, 0xc0000000, 0xbfdc28f5, 0xc28f5c1c},     /* -0.44000=f(-0.44000)*/
...
{
  int n, d;
  const unsigned N = sizeof ( log1pf_vec ) / sizeof ( log1pf_vec[0] );
  unsigned i;
  ...
  for ( i = 0; i < N; ++i )
  {
    param.l_value.high = log1pf_vec[i][6];
    param.l_value.low = log1pf_vec[i][7];
    result.l_value.high = log1pf_vec[i][4];
    result.l_value.low = log1pf_vec[i][5];

    f_param = (float) param.d_value;
    f_result = (float) result.d_value;

    f_ret = log1pf(f_param);
    if (log1pf_vec[i][1] == 13)
    {
      if ( ( f_ret <= f_result+(log1pf_vec[i][2]*EPSILON) && f_ret >= f_result-(log1pf_vec[i][2]*EPSILON) ) )
      {
        return ( -1 );
      }
    }
    else if (log1pf_vec[i][1] == 0)
    {
      if ( !( f_ret <= f_result+(log1pf_vec[i][2]*EPSILON) && f_ret >= f_result-(log1pf_vec[i][2]*EPSILON) ) )
      {
        return ( -1 );
