...
enum command_line_switch
  {
    ...
    OPTION_STACK,
    OPTION_SUBSYSTEM,
    OPTION_LDRXPIC_MAJOR,
    OPTION_LDRXPIC_MINOR
  };
...
static struct option copy_options[] =
{
  ...
  {"ldrxpic_major", required_argument, 0, OPTION_LDRXPIC_MAJOR},
  {"ldrxpic_minor", required_argument, 0, OPTION_LDRXPIC_MINOR},
  {0, no_argument, 0, 0}
};
...
\n\
  ldrxpic target specific options:\n\
  --ldrxpic_minor                  Set minor version\n\
  --ldrxpic_major                  Set major version\n\n\
"));
...
int z = OPTION_LDRXPIC_MAJOR;
	...
	case OPTION_LDRXPIC_MAJOR:
	    {
	      char *end;
              unsigned short ldrxpic_major_val = strtoul (optarg, &end, 0);
              /* non_fatal (_("Info: ldrxpic_major_version = %d"), ldrxpic_major_val); */
	      ldrxpic_major_set(ldrxpic_major_val);
	    }
          break;

	case OPTION_LDRXPIC_MINOR:
	    {
	      char *end;
	      unsigned short ldrxpic_minor_val = strtoul (optarg, &end, 0);
	      /* non_fatal (_("info: ldrxpic_minor_version = %d"), ldrxpic_minor_val); */
	      ldrxpic_minor_set(ldrxpic_minor_val);
	    }
          break;
