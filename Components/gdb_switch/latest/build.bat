@ECHO OFF
rem AR: This file copyed from "C:\Programme\Microsoft SDKs\Windows\v7.1\Bin" and changed: 
rem AR: comment on line  211, 172,  and insert lines 560, 561, 562
...
rem FOR /F "tokens=2* delims=	 " %%A IN ('REG QUERY "%VSRegKeyPath%" /v 10.0') DO SET VSINSTALLDIR=%%B
