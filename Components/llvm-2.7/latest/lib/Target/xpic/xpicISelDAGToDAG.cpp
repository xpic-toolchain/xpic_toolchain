...
public:
  ...
  bool SelectConstMem(SDNode *Op, SDValue N, SDValue &R);
  // frame+offset // Complex Pattern (3.03.2010)
  bool SelectADDRframe(SDNode *N, SDValue Addr,SDValue &Reg,SDValue &Base, SDValue &Offset);
  // frame (3.03.2010)
  ...
  bool SelectADDRrr(SDNode *N, SDValue Addr, SDValue &R1, SDValue &R2);
  bool SelectADDRComplex(SDValue Op, SDValue Addr,SDValue &R1, SDValue &R2, SDValue &R3);

  bool SelectADDRri(SDNode *N, SDValue Addr, SDValue &Base,SDValue &Offset);

  bool SelectADDRw(SDNode *N, SDValue Addr, SDValue &Out);
...
/// +
bool xpicDAGToDAGISel::SelectADDRframe(SDNode *N, SDValue Addr, SDValue  &Reg, SDValue &Base, SDValue &Offset)
{
...
/// ++
bool xpicDAGToDAGISel::SelectConstMem(SDNode *Op, SDValue Const, SDValue &Result)
{
  if( ConstantSDNode *C = dyn_cast<ConstantSDNode>(Const) )
  {
    ...
    Result = CurDAG->getTargetGlobalAddress(NewGV, MVT::i32);
    return true;
  }
  return false;
}
...
/// 31.03.2010
bool xpicDAGToDAGISel::SelectADDRri(SDNode *N, SDValue Addr, SDValue &Base, SDValue &Offset)
{
...
bool xpicDAGToDAGISel::SelectADDRrr(SDNode *N, SDValue Addr, SDValue &R1, SDValue &R2){
...
bool xpicDAGToDAGISel::SelectADDRw(SDNode *N, SDValue Addr, SDValue &Out)
{
