...
/// AR: +++
 PSFilename.eraseSuffix();
 static int k=0;
 std::stringstream os;
 os <<"/home/artem/Graph_llvm-2.7/"<<k;
 k++;
 std::string component = os.str(); //retrieve as a string
 PSFilename.set(component); 
/// AR: ---
...
//AR:  errs() << "Running '" << prog.str() << "' program... ";
...
//AR:    errs() << " done. \n";
errs()<<"Graph "<<k<<" saved in: "<< PSFilename.c_str();
    errs() << ", done \n";
/*
